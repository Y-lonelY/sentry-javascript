...
var BrowserTracing = /** @class */ (function () {
    ...
    BrowserTracing.prototype.setupOnce = function (_, getCurrentHub) {
        ...
        var _a = this.options, instrumentRouting = _a.routingInstrumentation, startTransactionOnLocationChange = _a.startTransactionOnLocationChange, startTransactionOnPageLoad = _a.startTransactionOnPageLoad, markBackgroundTransactions = _a.markBackgroundTransactions, traceFetch = _a.traceFetch, traceXHR = _a.traceXHR, tracingOrigins = _a.tracingOrigins, autoSentryTrace = _a.autoSentryTrace, shouldCreateSpanForRequest = _a.shouldCreateSpanForRequest;
        ...
        instrumentOutgoingRequests({ traceFetch: traceFetch, traceXHR: traceXHR, tracingOrigins: tracingOrigins, autoSentryTrace: autoSentryTrace, shouldCreateSpanForRequest: shouldCreateSpanForRequest });
    };
